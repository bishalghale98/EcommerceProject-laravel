                            ...
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" id="logo_header_mobile" alt=""
                                        src="{{ asset('images/logo/bstorelogo.png') }}"
                                        data-light="{{ asset('images/logo/bstorelogo.png') }}"
                                        data-dark="{{ asset('images/logo/bstorelogo.png') }}" data-width="154px"
                                        data-height="52px" data-retina="{{ asset('images/logo/bstorelogo.png') }}">
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                </div>
